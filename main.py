...
class initializer:
    def __init__(self, username, password, query, personalized_note=None):
        ...
        self.driver = webdriver.Chrome(executable_path=f"{os.getcwd()}/resources/chromedriver")
            ...
            if connect_eles:
                ...
                for index in range(loop) or []:
                    ...
                    send_ele = self.get_element(
                        by=By.XPATH, value="//button[@aria-label='Send now']"
                    )
...
if __name__ == "__main__":
    ...
    I’d love to connect with you for future opportunities and I am more than happy to help you connect with my network 
    and I am sure that it will be beneficial for both of us
    """
    }
    trupti_details = {
        "username": "truptikolekar12@gmail.com",
        "password": "Rudra@101383",
        "query": "SRE Devops",
        "personalized_note": f"""
    I’m a SRE Devops Engineer with 4+ years of experience. 
    It would be great to connect and see if we could knowledge share at some point in the future.
